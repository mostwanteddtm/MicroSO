;https://code.google.com/p/brook-os/source/browse/
;bits 16
use16
...
jmp completefail
hddfail:
mov byte [bsDriveNumber],0x00
jmp main
fddfail:
mov byte [bsDriveNumber],0x80
completefail:
          mov     si, msgFailure
          call    prnstr
          xor ah,ah
     ...
     cluster     dw 0x0000
     ImageName   db "BRKLDR  COM"
     msgLoading  db "Loading BRKLDR.COM", 0x00
	 msgKernel   db "Files:", 0x00
     msgFailure  db "Fal",0x00
