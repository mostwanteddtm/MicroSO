...
;=============================
 mov  si, OFFSET strcdx	; display the text for Xcoord
 call disp
 mov  al, BYTE PTR [XCOORDN]
 or   al, al
 jz  negative
 mov  si, OFFSET strneg	; if the sign bit is 1 then display - sign
 call disp
 jmp positive
negative:
 mov  si, OFFSET strsp		; else display a space
 call disp
positive:
 xor  ah, ah
...
;=============================
 mov  si, OFFSET strcdy	; display the text for Ycoord
 call disp
